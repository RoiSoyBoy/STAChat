...
export default function TestPage() {
  return (
    <div dir="rtl" className="min-h-screen flex flex-col bg-gray-50 font-sans relative">
      {/* Navigation Bar */}
      <nav className="w-full bg-white shadow-sm py-4 px-6 flex justify-between items-center">
        <div className="text-2xl font-bold text-blue-700 tracking-tight">צ׳אט בוט חכם</div>
        <div className="flex gap-6 text-lg font-medium">
          <a href="#" className="hover:text-blue-600 transition">בית</a>
          <a href="#" className="hover:text-blue-600 transition">אודות</a>
      ...
      <div className="flex-1 flex flex-col justify-center items-center w-full max-w-6xl mx-auto px-4 py-8">
        <div className="w-full flex flex-col md:flex-row gap-8 items-stretch justify-center">
          ...
          <main className="flex-1 flex flex-col justify-center items-center bg-white rounded-2xl shadow p-8 min-h-[320px]">
            <h1 className="text-4xl font-bold text-gray-900 mb-6 text-center">דף הבית</h1>
          ...
          <aside className="w-full md:w-1/3 flex flex-col justify-center items-center bg-gray-100 rounded-2xl shadow p-8 min-h-[320px] md:max-w-xs mx-auto md:mx-0">
            ...
            <p className="text-gray-600 text-center">
              זהו דף בדיקה לצ׳אט בוט. כאן תוכל לבדוק את תפקוד הצ׳אט, להתרשם מהעיצוב ולפנות אלינו בכל שאלה.
            </p>
          </aside>
        </div>
      </div>
      ...
      <section id="contact" className="w-full bg-white py-12 px-4 flex flex-col items-center">
        <h2 className="text-2xl font-bold text-blue-700 mb-4">צור קשר</h2>
        <form className="w-full max-w-md space-y-4">
          <div>
            <label htmlFor="name" className="block text-right text-gray-700 mb-1">שם</label>
            <input
              id="name"
              name="name"
              type="text"
          ...
          <div>
            <label htmlFor="email" className="block text-right text-gray-700 mb-1">דוא"ל</label>
            <input
              id="email"
              name="email"
              type="email"
          ...
          <div>
            <label htmlFor="message" className="block text-right text-gray-700 mb-1">הודעה</label>
            <textarea
              id="message"
              name="message"
              rows={4}
