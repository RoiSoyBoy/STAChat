...
import { adminDb, QueryDocumentSnapshot } from '@/lib/firebaseAdmin'; // Combined and updated import
...
export async function GET(request: NextRequest) {
  ...
  const messages = snapshot.docs.map((doc: QueryDocumentSnapshot) => ({ id: doc.id, ...doc.data() }));
